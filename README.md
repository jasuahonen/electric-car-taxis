...
## 1.1 Add a Car (POST)
```bash
curl -X POST -H "Content-Type: application/json" -d '{"id": "car-1", "model": "Tesla Model S", "batteryCapacity": 100, "currentBatteryLevel": 30, "charging": false}' http://localhost:8080/fleet/cars
```
```bash
